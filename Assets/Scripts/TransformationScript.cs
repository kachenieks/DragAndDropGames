...
public class TransformationScript : MonoBehaviour
{
    ...
    void Update()
    {
        if(ObjectScript.lastDragged != null) {
            ...
            {
                if(ObjectScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y < 1.05f)
                {
            ...
            {
                if (ObjectScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x < 1.05f)
                {
                    ObjectScript.lastDragged.GetComponent<RectTransform>().transform.localScale =
                        new Vector3(ObjectScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x,
                        ObjectScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y + 0.005f, 1f);
